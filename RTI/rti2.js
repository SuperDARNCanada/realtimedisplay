...
function realTimeChartMulti(radar) {
    console.log(radar)
    ...
    var version = "0.1.0",
      ...
      maxY = sites[radar.toString()]["maxRangeGates"], minY = 0,
  ...
  var chart = function(s) {
    ...
    function refresh() {
      ...
      var updateSelNav = navG.selectAll("rect")
          .data(data);
...
//      if (doSimple) {
//        obj = {
//          // simple data item (simple black rect of constant size)
//          time: now,
//          color: "black",
//          opacity: 1,
...
function RadarConnections(){
  ...
  for(var s in sites){
    (function(i){
      onMessageFunctions[i] = function(evt){self.on_message(evt,i);};
    })(site);
  }
...
RadarConnections.prototype.on_message = function(evt,radar){
...
radarConnections = new RadarConnections()
