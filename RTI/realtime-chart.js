...
function realTimeChartMulti() {
    var version = "0.1.0",
      ...
      timeDelay = 1, timeMultiplier = 7000, maxSeconds = 1400, pixelsPerSecond = 1, // pixelsPerSeconds changes the speed the chart moves... create some function to calculate what this should be? 
